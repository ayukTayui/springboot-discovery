...
@Entity
@Service
@Table(name = "CREDIT_CARD_LIMIT", catalog = "discovery", schema = "")
@XmlRootElement
@NamedQueries({
...
public class CreditCardLimit implements Serializable {
    ...
    public String toString() {
        return "CreditCardLimit{" + "creditCardLimitId=" + creditCardLimitId + ", accountLimit=" + accountLimit + ", clientAccountNumber=" + clientAccountNumber + '}';
    }
