...
@Entity
@Service
@Table(name = "ATM_ALLOCATION", catalog = "discovery", schema = "")
@XmlRootElement
@NamedQueries({
...
public class AtmAllocation implements Serializable {
    ...
    public String toString() {
        return "AtmAllocation{" + "atmAllocationId=" + atmAllocationId + ", atmId=" + atmId + ", denominationId=" + denominationId + ", count=" + count + '}';
    }
