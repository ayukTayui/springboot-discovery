...
@Entity
@Service
@Table(name = "CURRENCY_CONVERSION_RATE", catalog = "discovery", schema = "")
@XmlRootElement
@NamedQueries({
...
public class CurrencyConversionRate implements Serializable {
    ...
    public String toString() {
        return "CurrencyConversionRate{" + "currencyCode=" + currencyCode + ", conversionIndicator=" + conversionIndicator + ", rate=" + rate + '}';
    }
