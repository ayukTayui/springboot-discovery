 ...
 */
@Entity
@Table(name = "currency_conversion_rate", catalog = "spring_discovery", schema = "")
@XmlRootElement
@NamedQueries({
...
public class CurrencyConversionRate implements Serializable {
   private static final long serialVersionUID = 1L;
    ...
    public String toString() {
        return "za.co.discovery_bank.entities.CurrencyConversionRate[ currencyCode=" + currencyCode + " ]";
    }
